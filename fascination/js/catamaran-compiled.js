System.register(["events/Events", "extend/Extend"], function (_export) {
    "use strict";

    var Events, Extend, Catamaran;
    ...
    return {
        setters: [function (_eventsEvents) {
            Events = _eventsEvents["default"];
        }, function (_extendExtend) {
            Extend = _extendExtend["default"];
        }],
        execute: function () {
            Catamaran = (function () {
                function Catamaran() {
